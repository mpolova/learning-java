// A small program which prints only the local files in a given directory. The list of elements in the directory is stored in DIRECTORY_CONTENT, but :
// All elements contain first the type, then the element
// /d means directory,
// /f means file
// Some files are hidden, and contain a "."
// Files in other directors should not be printed 
